...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{!! '/assets/main/js/togglepassword.js' !!}">
    ...
    <script type="text/javascript"
        src="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.2.0/css/fontawesome.min.css"></script>
...
<body>
    ...
    <script src="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.2.0/css/fontawesome.min.css"></script>
</body>
